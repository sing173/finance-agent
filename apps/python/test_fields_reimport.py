"""Test field extraction with reimport."""
import sys, os
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath('.')), 'src'))

# Force reimport
if 'finance_agent_backend.tools.icbc_receipt_grid_parser' in sys.modules:
    del sys.modules['finance_agent_backend.tools.icbc_receipt_grid_parser']
if 'finance_agent_backend.tools' in sys.modules:
    del sys.modules['finance_agent_backend.tools']
if 'finance_agent_backend' in sys.modules:
    del sys.modules['finance_agent_backend']
